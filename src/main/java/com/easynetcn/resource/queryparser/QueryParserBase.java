...
public abstract class QueryParserBase extends QueryBuilder {
  ...
  */
  ...
  protected Query handleBareTokenQuery(String qfield, Token term, Token fuzzySlop, boolean prefix, boolean wildcard, boolean fuzzy, boolean regexp) throws ParseException {
    Query q;
    ...
    if (wildcard) {
      ...
      q = getPrefixQuery(qfield,
          new String(term.image.substring
  ...
  protected Query handleBareFuzzy(String qfield, Token fuzzySlop, String termImage)
      throws ParseException {
    Query q;
