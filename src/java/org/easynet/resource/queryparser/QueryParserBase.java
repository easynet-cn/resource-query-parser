...
public abstract class QueryParserBase extends QueryBuilder {
	...
	// (For example, analyzing terms into collation keys for locale-sensitive
	// RangeQuery)
	 ...
	 * influence score c) avoids any {@link TooManyClauses} exception. However,
	 * if your application really needs to use the old-fashioned
	 * {@link BooleanQuery} expansion rewriting and the above points are not
	 ...
	 * {@link TermRangeQuery}s. For example, setting this to true can enable
	 * analyzing terms into collation keys for locale-sensitive
	 * {@link TermRangeQuery}.
	 * 
	 * @param analyzeRangeTerms
	...
	/**
	 * @return whether or not to analyze range terms when constructing
	 *         {@link TermRangeQuery}s.
	 */
