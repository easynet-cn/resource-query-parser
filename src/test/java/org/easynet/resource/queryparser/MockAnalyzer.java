 ...
 * <li>Payload data is randomly injected into the stream for more thorough
 * testing of payloads.
 * </ul>
 * 
 * @see MockTokenizer
...
public final class MockAnalyzer extends Analyzer {
	...
	/**
	 * Calls
	 * {@link #MockAnalyzer(Random, CharacterRunAutomaton, boolean, CharacterRunAutomaton)
	...
	/**
	 * Get the offset gap between tokens in fields if several fields with the
	 * same name were added.
	 * 
	 * @param fieldName
